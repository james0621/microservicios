...
public class ClientController {
	...
	public ResponseEntity<List<ClientDto>> getByAgeGreatherThanEqual(@PathVariable Integer age) {
		return clientService.findByAgeGreatherThanEqual(age).isEmpty()
	...
	public ResponseEntity<ClientDto> update(@Valid @RequestPart ClientDto client, @RequestParam(required = false) MultipartFile file,@PathVariable Long id) throws IOException {
