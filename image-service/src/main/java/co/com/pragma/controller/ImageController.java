...
public class ImageController {
	...
	@GetMapping("/")
	public ResponseEntity<List<ImageMongoDto>> findAll(){
	...
	@GetMapping("/{id}")
	public ResponseEntity<ImageMongoDto> findById(@PathVariable String id) {
	...
	public ResponseEntity<ImageMongoDto> save(@RequestPart MultipartFile file , @RequestParam Long docClient) throws IOException{
